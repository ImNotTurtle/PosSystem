    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="{{ route('category_submit') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Aside column-->
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                [data-bs-theme="dark"] .image-input-placeholder { background-image: url('assets/media/svg/files/blank-image-dark.svg'); }</style>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Select2-->
                                <select class="form-select mb-2" name = "category_status" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                                    @php
                                        $category_status_table = App\Models\CategoryStatusModel::all();
                                        $first_status = $category_status_table->first();
                                    @endphp
                                    @foreach ($category_status_table as $category_status)
                                        <option value="{{ $category_status->id }}"
                                        @if ($category_status->id == $first_status->id) selected="selected" @endif>
                                        {{ $category_status->name }}</option>
                                    @endforeach
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div>
                                    ...
                                    <div id="kt_ecommerce_add_category_description" name="kt_ecommerce_add_category_description" class="min-h-200px mb-2">
                                        <input type="text" name="description" class="form-control mb-2" placeholder="Description" value="" />
                                    </div>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
